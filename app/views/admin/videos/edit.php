	...
	<div class="row-fluid">
		<form method="POST" class="form-horizontal span12" action="<?php echo str_replace('/edit', '', URL::current()); ?>" enctype="multipart/form-data">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="title" name="title" placeholder="Title" class="span3" value="<?php echo $video->title; ?>" required="true" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="youtube_url">Youtube URL</label>
				<div class="controls">
					<input type="text" id="youtube_url" name="youtube_url" placeholder="Youtube URL" class="span3" value="<?php echo $video->youtube_url; ?>" required="true" />
				</div>
			</div>
			<div class="control-group">
				...
				<div id="scheduler" class="controls">
						<?php 
							if(is_array($video->schedules_start)):
							foreach($video->schedules_start as $schedule): ?>
							<div class="date-val">
								<input type="text" readonly name="date-start[]" value="<?php echo date('Y-n-j', $schedule->sec); ?>">
								<input type="text" readonly  name="time-start[]" value="<?php echo date('g:ia', $schedule->sec); ?>">
								<a href="#" class="btn-link remove-schedule"><i class="icon-remove"></i></a>
							</div>
						<?php endforeach;
							endif;
						 ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="like" placeholder="Page Id" class="span3" value="<?php echo $video->page ?>"/>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="share">Share</label>
				<div class="controls">
					<input type="checkbox" name="share" <?php echo $video->share ? "checked='true'" : null ?> />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="description">Description</label>
				<div class="controls">
					<textarea id="description" rows="5" name="description" placeholder="Description" class="span5"><?php echo $video->description; ?></textarea>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="tags">Tags</label>
				<div class="controls">
					<textarea rows="5" name="tags" placeholder="Tags" class="span5">
						<?php if(isset($video->tags)):?><?=implode(", ", $video->tags)?><?php endif;?>
					</textarea>
				</div>
			</div>
			<div class="control-group">
